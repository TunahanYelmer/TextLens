    ...
    var t = {
        ...
        760: (t, e, r) => {
          ...
          var o = (function (t) {
            ...
            return (
              (b.prototype = w),
              i(j, "constructor", { value: w, configurable: !0 }),
                  ...
                  return o().wrap(function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 2:
                          return (
                            (n = t.sent), (t.next = 5), n.loadLanguage("osd")
                          );
                        case 5:
            ...
            {},
            {
              workerPath:
                ...
                "development" === process.env.TESS_ENV
                  ? ((c = "/dist/worker.dev.js?nocache=".concat(
                      Math.random().toString(36).slice(3)
                    )),
                    new URL(c, window.location.href).href)
                  : "https://cdn.jsdelivr.net/npm/tesseract.js@v".concat(
                      u,
                      "/dist/worker.min.js"
                    ),
              corePath: null
